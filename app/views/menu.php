        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top topo-fundo "><!--inicio da barrada de navegação do site-->
            <div class="container-fluid topo "><!--logo e barra de navegação-->
                <a class="navbar-brand" href="index.php"><!--link que esta embutido no logo-->
                    <img src="public/img/logo.png" alt="Logo"  class=" logo"><!--foto do logo-->
                </a>
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link links" href="index.php#servicos">Serviços</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link links" href="index.php#contato">Contato</a>
                  </li>
                  <li class="nav-item">
